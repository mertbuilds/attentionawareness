...
describe('buildProfile', () => {
  ...
  // Only an unsupervised iPhone ever needed the key, and the product now
  // requires supervision.
  it('omits ContentFilterUUID in both filter modes', () => {
...
describe('presets', () => {
  it('builds the mert preset with every blocked bundle id', () => {
    ...
    expect(presets.mert.blockedApps).toHaveLength(10);
